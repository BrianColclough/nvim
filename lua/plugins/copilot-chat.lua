local prompts = {
	...
	CommitStaged = {
		prompt = "Write commit message for the current changes. Make sure the title of the commit is the name of the current branch. Wrap the whole message in code block with language gitcommit.",
...
return {
	...
	keys = {
		...
		{ "<leadaer>ccd", "<cmd>CopilotChatFixDiagnostic<CR>" },
